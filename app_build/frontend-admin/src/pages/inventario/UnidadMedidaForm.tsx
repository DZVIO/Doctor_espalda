...
export const UnidadMedidaForm: React.FC = () => {
  ...
  useEffect(() => {
    if (isEdit && id) {
      fetchRequest(unidadMedidaService.getById(parseInt(id)), {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const apiCall = isEdit 
      ? unidadMedidaService.update(parseInt(id!), formData)
      : unidadMedidaService.create(formData);

    await request(apiCall, {
      successMessage: `Unidad de Medida ${isEdit ? 'actualizada' : 'creada'} correctamente`,
      onSuccess: () => navigate('/inventario/unidades-medida'),
    });
  };
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <form onSubmit={handleSubmit}>
            ...
            <FormField label="Nombre de la Unidad *" id="unidad">
              <input
                type="text"
                name="unidad"
                id="unidad"
            ...
            <FormField label="Abreviatura *" id="abreviatura">
              <input
                type="text"
                name="abreviatura"
                id="abreviatura"
            ...
            <div className="mt-6 flex justify-end space-x-3">
              <button
                type="button"
                onClick={() => navigate('/inventario/unidades-medida')}
